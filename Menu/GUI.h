...
// Colors
#define MENU_COLOR_CONTROL Color(180, 180, 180)
#define MENU_COLOR_CONTROL_BORDER Color(110, 110, 110)
...
class MButton : public CObject
{
	std::wstring m_label;
	std::function<void()> m_cb;
public:
	MButton(int width = 0, int height = 0, std::wstring label = L"", std::function<void()> cb = {});
	void Paint(int t_x = 0, int t_y = 0, float* controlheight = nullptr);
	void Click();
};
